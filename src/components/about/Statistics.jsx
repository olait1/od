        ...
        <div className="mt-8 flex flex-col md:justify-between items-stretch gap-2">
          ...
          <div className=" ">
            ...
            <span className="text-text">
              {" "}
              female former sex workers across sub saharan Africa before{" "}
            </span>
        ...
        <div className="flex flex-wrap mt-8 w-full lg:gap-16 md:gap-8 gap-6">
          ...
          <div className="w-72 flex-grow">
            <p className="text-text leading-relaxed text-justify">
              ...
              workers across sub saharan Africa before 2030. We already
              commenced this mission of rehabilitating prostitutes. Since the
              inception of this movement in 2013. We have rescued over 250 women
              from prostitution in Nigeria, Women whom we call “our converts”.
            ...
            <p className="text-text leading-relaxed mt-4">
              ...
              brothels across Nigeria. With the help of our volunteers in other
              states of Nigeria . We carry out thorough “brothel storms”
              targeted at transforming female prostitutes. ODF tactfully carry
              out these projects through spiritual , evangelical and persuasive
              dialogues . Our volunteer workers are also females who are well
              trained and equipped to partake in the outreaches.
            </p>
          </div>
        </div>
      </div>
