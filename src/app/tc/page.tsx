export default function TermsAndCOnditions() {
  return (
    <div className="container style-root pb-16">
      <style>{`
        .style-root a {
          color: #ff2251;
        }
        ...
        .style-root h3,.style-root h4,.style-root h5,.style-root h6 {
            font-size: 1.5em;
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Omovigho Donald Foundation, Nigeria.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Omovigho Donald Foundation,
            accessible from{" "}
            <a
              href="https://omovigho-donald-foundation.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://omovigho-donald-foundation.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://omovigho-donald-foundation.vercel.app/team"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://omovigho-donald-foundation.vercel.app/team
          </a>
        </li>
      </ul>
    </div>
